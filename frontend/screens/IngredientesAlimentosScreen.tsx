...
function IngredientesAlimentosWeb() {
  return (
...
// La versión para dispositivos móviles - funcionalidad similar a QRScannerScreen
function IngredientesAlimentosApp() {
  const navigation = useNavigation();
  // Estado para manejar la imagen capturada
  ...
  const handleOpenCamera = async () => {
    try {
      ...
      const result = await ImagePicker.launchCameraAsync({
        allowsEditing: true,
        aspect: [4, 3], // Proporción más amplia para etiquetar alimentos
        quality: 0.8,
      });
  ...
  const handleProcessImage = () => {
    alert('Esta función analizará los ingredientes del alimento en el futuro.');
        ...
        <View style={styles.imagePreviewContainer}>
          ...
          <View style={styles.previewButtonsContainer}>
            ...
            >
              ...
              <Text style={styles.previewButtonText}>Analizar Ingredientes</Text>
            </TouchableOpacity>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <Text style={styles.title}>Análisis de Ingredientes</Text>
        
        <Text style={styles.instructions}>
          Toma una foto de la etiqueta de ingredientes de un alimento para analizarla, o selecciona una imagen de tu galería.
        </Text>
        ...
        <View style={styles.infoContainer}>
          <MaterialIcons name="info-outline" size={24} color="#690B22" />
          <Text style={styles.infoText}>
            Esta función te ayudará a identificar ingredientes potencialmente perjudiciales en productos alimenticios.
          </Text>
        </View>
...
export default Platform.OS === 'web' ? IngredientesAlimentosWeb : IngredientesAlimentosApp;
...
const styles = StyleSheet.create({
  ...
  previewImage: {
    ...
    height: Dimensions.get('window').width * 0.7, // Más rectangular para etiquetas
    borderRadius: 12,
    marginBottom: 20,
    backgroundColor: '#FFF',
    shadowColor: '#000',
