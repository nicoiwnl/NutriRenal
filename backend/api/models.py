...
class Alimento(models.Model):
    ...
    nombre = models.CharField(max_length=100, unique=True)
    energia = models.DecimalField(max_digits=7, decimal_places=2)
    humedad = models.DecimalField(max_digits=7, decimal_places=2, default=0.0)
    cenizas = models.DecimalField(max_digits=7, decimal_places=2)
    proteinas = models.DecimalField(max_digits=7, decimal_places=2)
    hidratos_carbono = models.DecimalField(max_digits=7, decimal_places=2)
    azucares_totales = models.DecimalField(max_digits=7, decimal_places=2)
    fibra_dietetica = models.DecimalField(max_digits=7, decimal_places=2)
    lipidos_totales = models.DecimalField(max_digits=7, decimal_places=2)
    acidos_grasos_saturados = models.DecimalField(max_digits=7, decimal_places=2)
    acidos_grasos_monoinsaturados = models.DecimalField(max_digits=7, decimal_places=2)
    acidos_grasos_poliinsaturados = models.DecimalField(max_digits=7, decimal_places=2)
    acidos_grasos_trans = models.DecimalField(max_digits=7, decimal_places=2)
    colesterol = models.DecimalField(max_digits=7, decimal_places=2)
    vitamina_A = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    vitamina_C = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    vitamina_D = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    vitamina_E = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    vitamina_K = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    vitamina_B1 = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    vitamina_B2 = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    niacina = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    vitamina_B6 = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    acido_pantotenico = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    vitamina_B12 = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    folatos = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    sodio = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    potasio = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    calcio = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    fosforo = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    magnesio = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    hierro = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    zinc = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    cobre = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    selenio = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    alcohol = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    activo = models.BooleanField(default=True)
...
class CentroMedico(models.Model):
    ...
    tipo_centro = models.CharField(max_length=255, blank=True, null=True)
